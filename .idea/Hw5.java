 ...
 * 
 * @author Ryan Kuchenthal, 3241 (parseE and eval)
...
public class Hw5 {
    ...
    public static int eval(TreeNode noderef) {
     ...
     else if(noderef.getChildCount() == 3){
         if(noderef.getChildAt(0).toString().equals("*")){
           
            //int x = Integer.parseInt(noderef.getChildAt(1).toString());
            //int y = Integer.parseInt(noderef.getChildAt(2).toString());
            
            int z = eval(noderef.getChildAt(1)) * eval(noderef.getChildAt(2));            
            return z;
            
         }
         else if(noderef.getChildAt(0).toString().equals("+")){
           int z = eval(noderef.getChildAt(1)) + eval(noderef.getChildAt(2));            
           return z;           
    ...
    public static void main(String[] args) {
        ...
        //DefaultMutableTreeNode root = parsePrefixExpr(Arrays.asList("*","+","2","3","+","4"));
        //DefaultMutableTreeNode root = parsePrefixExpr(Arrays.asList("+","1","1"));
